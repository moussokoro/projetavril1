...
<body style="background: url(./images/imo.jpg)no-repeat;background-size:cover;">
    <section>
        <div class="container">
            <div class="jumbotron" style="margin: 100px;width: 150vh;margin-left: auto;">
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <strong><th>NOM-PRENOM</th></strong>
                    ...
                    <tbody>
                        <?php
                            $req = $bdd -> query("SELECT * FROM catalina");
                            while ($person = $req->fetch()) 
                            {
                                echo "<tr>";
                                echo "<td>" . $person['id'] . "</td>";
                                echo "<td>" . $person['nom_prenom'] . "</td>";
                ...
                <a href="form.php" class="btn btn-primary">creer un compte</a>
