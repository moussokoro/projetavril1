...
<body style="background: url(./image/image1.jpg)no-repeat; background-size: cover;margin-top: 100px; ">
    <section>
        <div class="container">
            <div class="jumbotron">
                ...
                <div class="return">
                    <a href="table.php" class="btn btn-info  btn-block btn-lg text-center"><i class="fas fa-arrow-left"></i>Retour</a>
                </div>
            </div>
        </div>
    </section>
