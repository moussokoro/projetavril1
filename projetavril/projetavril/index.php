...
<body>
<marquee style="color: rgba(242,202,39,0.4); width: 900px;margin-right: -50px;" ><h1>VOTRE MAISON ON LA VOIS COMME VOUS</h1></marquee>
...
<span id="imeline"></span>
 ...
 <div class="">
          <div class="about-head text-center">
            <h3>Quelques raisons pour choisir  <span>mariko immobilier</span></h3>
            <p>Pour tous actions sur notre plateforme vous devrez être inscrire!!!</p>
          </div>
           
          
            <div class="about-grids" style="background-position: -249px 0px;">
            <div class="col-md-3">
