    ...
    if(!empty($_POST)) 
    {
       ...
       $mdp = md5($_POST['mdp']);
        ...
        $valide = true;
            ...
            if ($valide){
                $db = Database::connect();
                $statement = $db->prepare("INSERT INTO catalina(email,nom_prenom,maison,password) VALUES(?,?,?,?)");
                $statement->execute(array($email,$nom_prenom,$maison,$mdp));
                Database::disconnect();
    ...
    ?>
        ...
        <div class="login-form">
            <div class="sign-in-htm">
                ...
                <div class="group">
                    <label for="text" class="label">maison</label>
